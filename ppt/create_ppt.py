...
ai_items = [
    ...
    ("⚙️ Full Stack Generation",RGBColor(0x93,0x33,0xea), "Generated complete HTML/CSS/JS website, folder structure, GitHub repository setup, and the video script — all through an AI-assisted development workflow."),
...
Full Stack Generation: "The AI-assisted workflow covered the complete deliverable — the website, GitHub repository setup, and the video script — through iterative natural language prompting."
...
GitHub Repository:
"All project files are on GitHub — the full HTML source code, this PowerPoint presentation, four Word documents (one per section), screenshots, and the README."
